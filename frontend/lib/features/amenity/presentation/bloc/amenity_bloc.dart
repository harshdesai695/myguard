...
class AmenityBloc extends Bloc<AmenityEvent, AmenityState> {
  AmenityBloc({required GetAmenitiesUseCase getAmenitiesUseCase, required GetAmenitySlotsUseCase getAmenitySlotsUseCase, required BookAmenityUseCase bookAmenityUseCase, required GetMyBookingsUseCase getMyBookingsUseCase, required CancelBookingUseCase cancelBookingUseCase}) : _getAmenitiesUseCase = getAmenitiesUseCase, _getAmenitySlotsUseCase = getAmenitySlotsUseCase, _bookAmenityUseCase = bookAmenityUseCase, _getMyBookingsUseCase = getMyBookingsUseCase, _cancelBookingUseCase = cancelBookingUseCase, super(const AmenityInitial()) {
    on<AmenitiesFetched>(_onFetched); on<AmenitySlotsFetched>(_onSlots); on<AmenityBooked>(_onBooked); on<MyBookingsFetched>(_onMyBookings); on<BookingCancelled>(_onCancelled);
  }
  final GetAmenitiesUseCase _getAmenitiesUseCase; final GetAmenitySlotsUseCase _getAmenitySlotsUseCase; final BookAmenityUseCase _bookAmenityUseCase; final GetMyBookingsUseCase _getMyBookingsUseCase; final CancelBookingUseCase _cancelBookingUseCase;
