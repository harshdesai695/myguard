...
class _PollManagementScreenState extends State<PollManagementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(onPressed: () {}, icon: const Icon(Icons.add_rounded), label: Text('Create Poll'), backgroundColor: AppColors.primary, foregroundColor: AppColors.onPrimary),
