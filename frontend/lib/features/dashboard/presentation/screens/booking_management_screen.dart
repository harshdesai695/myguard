...
class _BookingManagementScreenState extends State<BookingManagementScreen> {
  ...
  Future<void> _load() async {
    ...
    // GET /api/v1/amenities/bookings/admin
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loading ? const AppShimmerList() : RefreshIndicator(onRefresh: _load, child: ListView(children: [
        ...
        AppEmptyWidget(message: 'No data yet. Pull to refresh.', icon: Icons.book_online_outlined, actionLabel: 'Refresh', onAction: _load),
      ])),
    );
  }
}
