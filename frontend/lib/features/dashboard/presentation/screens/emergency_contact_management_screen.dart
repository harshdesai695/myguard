...
class EmergencyContactManagementScreen extends StatefulWidget {
  ...
  @override
  State<EmergencyContactManagementScreen> createState() => _EmergencyContactManagementScreenState();
}
class _EmergencyContactManagementScreenState extends State<EmergencyContactManagementScreen> {
  bool _loading = true;
  @override
