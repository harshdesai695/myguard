...
class _NoticeManagementScreenState extends State<NoticeManagementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(onPressed: () {}, icon: const Icon(Icons.add_rounded), label: Text('Create Notice'), backgroundColor: AppColors.primary, foregroundColor: AppColors.onPrimary),
