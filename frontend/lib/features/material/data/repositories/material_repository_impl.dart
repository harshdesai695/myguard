...
class MaterialRepositoryImpl implements MaterialRepository {
  ...
  @override Future<Either<Failure, PaginatedResponseModel<GatepassEntity>>> getAdminGatepasses({int page = 0, int size = 20}) async { try { return Right(await remoteDatasource.getAdminGatepasses(page: page, size: size)); } on DioException catch (e) { return Left(_m(e)); } catch (e) { return Left(UnknownFailure(e.toString())); } }
}
